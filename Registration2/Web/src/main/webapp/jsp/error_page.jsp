...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <h1>Opps...</h1>
            <a href="../Koh/index.html">fractals: type a number(1-10) and try to count sides of Koch snowflake </a>
            <% //TODO: переделать без выхода в интернет %>
           <br> <a href="http://csc.buxar-host.ru/"> Gleaming Star (please, follow instructions)</a>
            <br> <a href="../Tanks2/index.html">Tanks (instructions as above)</a>
            <br> <a href="../tic_toc/index.html">that's app just for rest: Tic toc</a>
